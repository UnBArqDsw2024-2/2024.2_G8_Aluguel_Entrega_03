...
<figcaption align='center'>
    <h6><b>Figura 3: Classe PropertyFactory. Autor(es): Ester Lino</h6></b>
</figcaption>

> > > > > > > 27e47f9bbc8d7a2d9392b01534065cd09d0c5bf1
...
- **Camada de Serviço**: Usa o objeto configurado pelo Builder para a lógica de negócio.
- **Camada de Repositório**: Recebe o objeto `CreatePropertyDto` construído pelo Builder para enviar ao banco.
...
### Uso no Método `create(dto: CreatePropertyDto)`:
...
| `6.0`  | 06/01/2025 |            Implementação e documentação do Padrão Builder            |                                [Caio Berg](https://github.com/Caio-bergbjj),[Arthur Gabriel](https://github.com/ArthurGabrieel)                                |